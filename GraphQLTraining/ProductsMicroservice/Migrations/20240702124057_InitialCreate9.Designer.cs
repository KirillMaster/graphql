...
namespace ProductsMicroservice.Migrations
{
    ...
    [Migration("20240702124057_InitialCreate9")]
            ...
            modelBuilder.Entity("ProductsMicroservice.FullRelational.Ribbon", b =>
                {
                    ...
                    b.HasIndex("ProductSku", "ProductVersionId", "ProductCurrencyCode")
                        .HasDatabaseName("ix_ribbon_productsku_productversionid_productcurrencycode");
            ...
            modelBuilder.Entity("ProductsMicroservice.FullRelational.Ribbon", b =>
                {
                    b.HasOne("ProductsMicroservice.FullRelational.Product", null)
                        ...
                        .HasForeignKey("ProductSku", "ProductVersionId", "ProductCurrencyCode")
                        .HasConstraintName("fk_ribbon_products_productsku_productversionid_productcurrency~");

                    b.HasOne("ProductsMicroservice.FullRelational.Product", null)
                        .WithMany("CategoryRibbons")
