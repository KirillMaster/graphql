...
namespace ProductsMicroservice.Migrations
{
    ...
    [Migration("20240704095125_initial9")]
            ...
            modelBuilder.Entity("ProductsMicroservice.FullRelational.CategoryProduct", b =>
                {
                    ...
                    b.HasKey("ProductSku", "CategoryId")
                        .HasName("pk_categoryproducts");

                    b.HasIndex("CategoryId")
                        .HasDatabaseName("ix_categoryproducts_categoryid");

                    b.HasIndex("ProductSku", "ProductVersionId", "ProductCurrencyCode")
                        .HasDatabaseName("ix_categoryproducts_productsku_productversionid_productcurrenc~");
            ...
            modelBuilder.Entity("ProductsMicroservice.FullRelational.ProductFacet", b =>
                {
                    ...
                    b.HasIndex("FieldName", "Value")
                        .HasDatabaseName("ix_productfacets_fieldname_value");
            ...
            modelBuilder.Entity("ProductsMicroservice.FullRelational.CategoryProduct", b =>
                {
                    b.HasOne("ProductsMicroservice.FullRelational.Category", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_categoryproducts_categories_categoryid");
                    ...
                    b.HasOne("ProductsMicroservice.FullRelational.Product", "Product")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_categoryproducts_products_productsku_productversionid_produ~");
